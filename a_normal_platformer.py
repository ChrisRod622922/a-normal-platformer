...
# Fonts
font_xs = load_font("assets/fonts/goodfish_rg.ttf", 16)
font_sm = load_font("assets/fonts/goodfish_rg.ttf", 32)
font_md = load_font("assets/fonts/goodfish_rg.ttf", 48)
font_lg = load_font("assets/fonts/goodfish_rg.ttf", 64)
